...
class TestRAGSystem:
    ...
    def test_query_without_session(self):
        ...
        self.mock_ai_generator.generate_response.return_value = "This is about Python programming."
    ...
    def test_query_with_session(self):
        ...
        # Mock AI generator response
        self.mock_ai_generator.generate_response.return_value = "Follow-up response about Python."
        
        # Mock tool manager sources
        self.mock_tool_manager.get_last_sources.return_value = []
        
        # Execute query
        response, sources = self.rag_system.query("Tell me more about functions", session_id)
    ...
    def test_query_with_sources(self):
        ...
        # Mock AI generator response
        self.mock_ai_generator.generate_response.return_value = "Here's information about data science."
    ...
    def test_query_complex_conversation_flow(self):
        ...
        self.mock_session_manager.get_conversation_history.return_value = "User asked about Python. AI explained basics."
        
        # Mock AI response with sources
        self.mock_ai_generator.generate_response.return_value = "Advanced Python concepts include classes and modules."
        mock_sources = [{"text": "Advanced Python - Lesson 5"}]
        self.mock_tool_manager.get_last_sources.return_value = mock_sources
        
        # Execute query
        response, sources = self.rag_system.query("What are advanced Python concepts?", session_id)
        ...
        assert call_args[1]["conversation_history"] == "User asked about Python. AI explained basics."
    ...
    def test_get_course_analytics(self):
        ...
        self.mock_vector_store.get_existing_course_titles.return_value = [
            "Python Basics", "Data Science 101", "Machine Learning", "Web Development", "AI Ethics"
        ]
